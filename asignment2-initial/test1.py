...
class ASTGenSuite(unittest.TestCase):
    ...
    def test101_inferred_types(self):
        input = """
            x: auto;
            y: string;
        """
    ...
    def test103_atomic_types_with_init(self):
        input = """
            x: integer = 14;
            y: float = 14.7e4;
    ...
    def test105_inferred_types_with_init(self):
        input = """
            x: auto = 5;
            y: integer = 6;
        """
    ...
    def test106_assign_with_basic_literal(self):
        input = """
            main: function void(){
                a = 1;
                b = 1.1;
    ...
    def test108_assign_with_multiD_array_literal(self):
        input = """main: function void(){
            a = {1,{2,{3,4}}};
        }"""
        expect = """Program([
    ...
    def test109_assign_with_mixedarray_literal(self):
        input = """main: function void(){
...
#     ##### STATEMENTS #####
    ...
    def test155_nested_forloop(self):
        input = """
        main: function void (){
    ...
    def test158_normal_dowhile(self):
        input = """
        main: function void (){
            do {
                a = a+1;
    ...
    def test160_break_and_return(self):
        input = """
        main: function void (){
            for(i=1,i<2,i+1){
                if(i==t)
    ...
    def test167_normal_return(self):
        input = """
            hello: function void(){
                printString("hello");
            }
    ...
    def test168_complex_return(self):
        input = """
    ...
    def test171_idx_for_loops(self):
        input = """
        main: function void (){   
            for(a[i]=1,i<5,i+1){}
        }
    ...
    def test172_idx_for_loops(self):
        input = """
        main: function void (){   
            for(a[i]=1,i<5,i+1){}
        }
    ...
    def test173_while_dowhile_1(self):
        input = """
        main: function void (){   
            while(true){
                do{}
    ...
    def test174_while_dowhile_2(self):
        input = """
        main: function void (){   
            while(true)
                do{}
    ...
    def test178_full_stmt_program_1(self):
        input = """main: function void () {
            // cond stmt
            if (a>1){
                a = 1;
    ...
    def test179_full_stmt_program_2(self):
        input = """main: function void () {
            a: integer;
            if (a>0)
                for(a=10,a>0,a-1)
    ...
    def test187_find_depth_tree(self):
        input = """
    ...
    def test190_random_1_empty(self):
        input = "main: function void(){}"
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([]))
])"""
    ...
    def test192_random_floatlit1(self):
        input = """main: function void(){
                a = .e23;
                b = 10.21e2;
            }"""
    ...
    def test193_random_4_vardecl_single_if(self):
        input = """main: function void(){
                if (n == 1)  {a,b: integer;}
            }"""
        expect = """Program([
    ...
    def test194_random_floatlit2(self):
        input = """main: function void(){
                a = .1e23;
                a = .1e-23;
                a = -.1e23;
    ...
    def test195_random_stringlit1(self):
        input = """main: function void(){
                a = "abc\txyz";
            }"""
        expect = r"""Program([
    ...
    def test196_random_stringlit2(self):
